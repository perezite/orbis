...
namespace Levels
{
	void LevelHelper::AddLevelSwitcher(Level * currentLevel, std::string targetLevelName, bool isForward)
	{
		...
		nextLevel->AddComponent(new LevelSwitchButtonController(targetLevelName, isForward));
